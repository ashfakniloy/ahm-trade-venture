...
import TradeVentureLogo from "../../public/images/logo/trade-venture-logo.png";
import {
  FaFacebook,
  FaTwitter,
  FaInstagram,
...
function Footer() {
  return (
    <div className="bg-custom-cyan text-white">
      <div className="container py-14 px-4">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 justify-between items-start">
          <div className="flex flex-col self-center lg:self-start">
            <div className="lg:mt-5 w-[160px]">
              <Image src={TradeVentureLogo} alt="blue horizons logo" />
            </div>
        ...
        <div className="mt-14 text-sm ">
          <p>&copy; 2022 AHM Trade Venture. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  );
