...
import BannerImage from "../../public/images/trade-venture.jpg";
    ...
    <div id="home" className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 container flex items-center text-white">
        <div className="lg:w-[615px] space-y-7">
          <h1 className="text-4xl font-semibold">AHM Trade Venture Title</h1>
          ...
          <div className="">
            <button
              type="button"
              className="mt-5 px-9 py-3 font-semibold text-white bg-custom-rose hover:bg-rose-900 transition duration-500"
            >
              Learn More
            </button>
          </div>
